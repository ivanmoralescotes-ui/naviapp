...
interface FirebaseOptions {
     ...
     * (example value: `SyDOCAbC123dEf456GhI789jKl012-MnO`).
     */
    apiKey?: string;
    /**
...
declare type Timestamp$1 = string | {
...
declare class ParseContextImpl implements ParseContext {
    ...
    readonly fieldTransforms: FieldTransform[];
    readonly fieldMask: FieldPath$2[];
    /**
     ...
     * compromised).
     */
    constructor(settings: ContextSettings, databaseId: DatabaseId, serializer: JsonProtoSerializer, ignoreUndefinedProperties: boolean, fieldTransforms?: FieldTransform[], fieldMask?: FieldPath$2[]);
    get path(): FieldPath$2 | undefined;
    ...
    childContextForFieldPath(field: FieldPath$2): ParseContextImpl;
    childContextForArray(index: number): ParseContextImpl;
    createError(reason: string): FirestoreError$1;
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */
    contains(fieldPath: FieldPath$2): boolean;
...
interface ParseContext {
    ...
    readonly ignoreUndefinedProperties: boolean;
    fieldTransforms: FieldTransform[];
    fieldMask: FieldPath$2[];
    get path(): FieldPath$2 | undefined;
    get dataSource(): UserDataSource;
    contextWith(configuration: Partial<ContextSettings>): ParseContext;
    childContextForField(field: string): ParseContext;
    childContextForFieldPath(field: FieldPath$2): ParseContext;
...
declare class Field extends Expression implements Selectable {
     ...
     * @param fieldPath
     */
    constructor(fieldPath: FieldPath$2, _methodName: string | undefined);
 ...
 * @returns A new `Constant` instance.
 */
declare function constant(value: Timestamp): Expression;
/**
 * @beta
 ...
 * ```
 */
declare class Pipeline$1 implements ProtoSerializable<Pipeline$2> {
    /**
     * @internal
     * @private
     */
     ...
     * @protected
     */
    protected newPipeline(db: Firestore$1, userDataReader: UserDataReader, userDataWriter: AbstractUserDataWriter, stages: Stage[]): Pipeline$1;
}
...
declare class PipelineSnapshot {
    ...
    constructor(pipeline: Pipeline$1, results: PipelineResult[], executionTime?: Timestamp);
    /**
...
declare class Pipeline extends Pipeline$1 {
     ...
     * @protected
     */
    protected newPipeline(db: Firestore, userDataReader: UserDataReader, userDataWriter: AbstractUserDataWriter, stages: Stage[]): Pipeline;
}
